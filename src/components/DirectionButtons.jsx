...
const DirectionButtons = ({
  ...
  return (
    <div className="col-span-1 row-span-2 flex items-center justify-center">
      <div className="w-full h-full relative flex items-center bg-[#000] md:border-[1px] border-[#000]">
        <div className="absolute inset-[1px] bg-[#000] rounded-sm">
          <div className="grid grid-rows-3 h-full w-full gap-[1px] md:gap-[2px] bg-[#000]">
            <motion.div
            ...
            >
              <span className="absolute pointer-events-none flex items-center justify-center w-[8px] md:w-[17px]">
                ...
                {Array(7)
                  ...
                  .map((_, index) => (
                    <div
                      ...
                      className={`h-full ${
                        index === 0
                          ? "w-[3px] md:w-[10px] shadow-[inset_-2px_0px_1px_#fff]"
                          : index === 6
                          ? "w-[3px] md:w-[10px] shadow-[inset_2px_0px_1px_#939393]"
                          : "w-[5px] md:w-[12px] shadow-[inset_2px_0px_1px_#939393,inset_-2px_0px_1px_#fff]"
                      } bg-[#d9d9d9]`}
                    ></div>
                  ))}
              </div>
