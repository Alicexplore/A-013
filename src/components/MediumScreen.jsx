...
const MediumScreen = ({ isPowerOn }) => {
  return (
    <div className="relative col-span-2 row-span-3 rounded-lg md:rounded-xl border-[0.5px] md:border-[1px] border-[#000] overflow-hidden">
      <div
