...
const Maintenance = () => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#222] bg-opacity-90 z-50 uppercase p-10">
        ...
        <div className="w-[300px] h-[240px] md:w-[400px] md:h-[320px] p-6 rounded-md md:rounded-lg text-center
         items-center justify-center flex flex-col">
            ...
            <div className="text-[#d9d9d9]/80 text-[9px] md:text-[13px] text-center p-2 md:p-3 mb-4 md:mb-5
            space-y-1">
            <motion.p
